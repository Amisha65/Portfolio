    ...
    <>
      ...
      >
        <div className={`${css.box} container mt-5 `}>
          <div className={`${css.heroRow} d-flex px-4 pt-4`}>
            <VisibilityWrapper delay={0.5}>
              <div className={`${css.column8} ${css.heroContent}`}>
                <p className={`${css.frondEnd} mb-1`}>Full Stack Developer</p>
            ...
            <VisibilityWrapper delay={0.7}>
              <div
                className={`${css.photoContainer} justify-content-center `}
              >
                <img
          ...
          <VisibilityWrapper delay={0.9}>
            <div className={`${css.links} pb-2 ps-4`}>
              <Links></Links>
            </div>
          </VisibilityWrapper>
        </div>
